...
public class BankAppSwing extends JFrame {
    ...
    public BankAppSwing() {
        setTitle("Банковское приложение (Swing)");
        ...
        transactionPanel.add(new JLabel("Операции:"), BorderLayout.NORTH);
        ...
        bottomPanel.add(new JLabel("Номер счета:"));
